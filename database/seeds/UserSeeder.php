...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        factory(\App\Models\User::class, 1)->create(['role' => 'admin', 'email' => 'admin@findbook.info', 'password' => \Illuminate\Support\Facades\Hash::make('T8RVeta1OpA')])->each(function (\App\Models\User $user) {
